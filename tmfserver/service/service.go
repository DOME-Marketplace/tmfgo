...
// Request and HttpAction are aliases to the definitions in types package
type Request = types.Request
type HttpAction = types.HttpAction

var HttpActionFromMethod = types.HttpActionFromMethod

const (
	ActionREAD    = types.ActionREAD
	ActionCREATE  = types.ActionCREATE
	ActionREPLACE = types.ActionREPLACE
	ActionUPDATE  = types.ActionUPDATE
	ActionDELETE  = types.ActionDELETE
	ActionLIST    = types.ActionLIST
)
